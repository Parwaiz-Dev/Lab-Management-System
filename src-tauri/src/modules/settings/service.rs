...
fn get_setting_or_default(key: &str, default_value: &str) -> AppResult<String> {
...
pub fn get_all_settings() -> AppResult<AppSettings> {
    Ok(AppSettings {
        lab_name: get_setting_or_default(KEY_LAB_NAME, "Your Lab")?,
        lab_address: get_setting_or_default(KEY_LAB_ADDRESS, "Your Address")?,
        doctor_share: get_setting_or_default(KEY_DOCTOR_SHARE, "0.4")?,
        lab_logo: get_setting_or_default(KEY_LAB_LOGO, "")?,
    })
}
