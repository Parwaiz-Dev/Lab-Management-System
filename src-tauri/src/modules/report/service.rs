...
pub fn get_report(conn: &Connection, order_id: i32) -> AppResult<Vec<ReportRow>> {
...
pub fn get_patient_by_order(conn: &Connection, order_id: i32) -> AppResult<ReportPatientInfo> {
    validate_positive_id(order_id, "order_id")?;
